...
(begin 33 (define pooding 3))
;expect pooding

(begin (define pooding (+ pooding 33)) 3.3)
;expect 3.3
...
(lambda (hot pot) (+ hot pot))
;expect (lambda (hot pot) (+ hot pot))
...
(define quadrupled (lambda (x) (* x x x x)))
(quadrupled 10)
;expect 10000
